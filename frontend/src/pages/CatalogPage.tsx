                  ...
                  {editingId === c.id ? (
                    ...
                    <div className="flex flex-col flex-1 h-full">
                      ...
                      <p className="text-xs text-gray-400 mb-4">{c.updatedAtLabel}</p>
                        ...
                        <Button className="w-full" onClick={() => navigate(`/catalogos/${c.id}`)}>
                          <ExternalLink className="w-4 h-4 mr-2" /> Abrir Vitrine
                        </Button>
                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                          <Button variant="secondary" size="sm" onClick={() => void handleShare(c.id)} title="Compartilhar" className="col-span-2 sm:col-span-1">
                            <Share2 className="w-4 h-4 mr-2" /> Compartilhar
                          </Button>
                          <Button variant="secondary" size="sm" onClick={() => startEdit(c)} title="Editar">
                            <Pencil className="w-4 h-4 mr-2" /> Editar
                          </Button>
                          <Button variant="secondary" size="sm" onClick={() => confirmDelete(c.id)} className="text-red-600 hover:bg-red-50 hover:text-red-700 hover:border-red-200" title="Apagar">
